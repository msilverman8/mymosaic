...
(function (global, factory) {
  ...
  var ConvertPhoto = /*#__PURE__*/function () {
    function ConvertPhoto(options) {
      ...
      this.options = Object.assign(defaults, options); // super(Object.assign(defaults, options))
      ...
      this.mosaicTileCount = []; // stores arrat of rows of tiles left to right as rgba strings
    ...
    */
    ...
    (0, _createClass2["default"])(ConvertPhoto, [{
      key: "getAverageColor",
      value: function getAverageColor(data) {
        var i = -4,
      ...
      value: function tileCanvas() {
        ...
        for (var i = 0; i < this.options.tilesY; i++) {
          ...
          for (var j = 0; j < this.options.tilesX; j++) {
            ...
            mosaicContext.fillRect(x, y, this.options.tileWidth, this.options.tileHeight); // super.createTiles(x, y, mosaicContext);
          }
        } // clear container and append mosaicCanvas to DOM


        this.options.targetElement.innerHTML = '';
        this.options.targetElement.appendChild(mosaicCanvas); // this.options.targetElement.appendChild(this.options.canvas);
      }
    }, {
      key: "getClusterData",
      ...
      */
      value: function getClusterData(startX, startY, width, originalImageData) {
        var data = [];
        ...
        for (var x = startX; x < startX + tileWidth; x++) {
          ...
          for (var y = startY; y < startY + tileHeight; y++) {
            var yPos = y * width * 4;
            data.push(originalImageData.data[xPos + yPos + 0], originalImageData.data[xPos + yPos + 1], originalImageData.data[xPos + yPos + 2], originalImageData.data[xPos + yPos + 3]);
          }
        }
